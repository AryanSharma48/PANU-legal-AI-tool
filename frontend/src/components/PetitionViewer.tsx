...
const PetitionViewer: React.FC<PetitionViewerProps> = ({ draft, onReset, language }) => {
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-12 pb-24">
      {/* This entire div is captured for PDF */}
      <div
        ref={petitionRef}
        className="bg-white p-12 md:p-20 old-money-border shadow-2xl parchment min-h-[1000px] relative overflow-hidden"
      >
        ...
        {/* Rendered Markdown with legal document styling */}
